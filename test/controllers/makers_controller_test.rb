...
class MakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maker" do
    assert_difference('Maker.count') do
      post makers_url, params: { maker: { email: @maker.email, first_name: @maker.first_name, last_name: @maker.last_name } }
    end
  ...
  test "should update maker" do
    patch maker_url(@maker), params: { maker: { email: @maker.email, first_name: @maker.first_name, last_name: @maker.last_name } }
